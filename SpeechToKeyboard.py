...
if __name__ == '__main__':
    ...
    COMMANDS = {
                #Mouse commands
                "move to": (pag.moveTo, 4),
                "move up": (pag.moveRel, 3),
                "move down": (pag.moveRel, 3),
                "move left": (pag.moveRel, 3),
                "move right": (pag.moveRel, 3), 
                "left click": (pag.click, 2),
                "double click": (pag.doubleClick, 2), 
                "right click": (pag.click, 2),
                "middle click": (pag.click, 2), 
                "hold left": (pag.mouseDown, 2),
                "hold right": (pag.mouseDown, 2), 
                "hold middle": (pag.mouseDown, 2),
                "release left": (pag.mouseUp, 2), 
                "release right": (pag.mouseUp, 2),
                "release middle": (pag.mouseUp, 2), 

                #Keyboard commands
                "scroll up": (pag.scroll, 3),
                "scroll down": (pag.scroll, 3), 
                "hold key": (pag.keyDown, 3),
                "release key": (pag.keyUp, 3), 
                "press key": (pag.press, 3),
                "use shortcut": (pag.hotkey, 0), 
                "type this": (pag.typewrite, 0),
                "quit program": (quit, 2)}
